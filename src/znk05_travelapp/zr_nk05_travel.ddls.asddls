...
define root view entity ZR_NK05_TRAVEL
  as select from znk05_atravel
  composition [0..*] of ZR_NK05_BOOKING as _Bookings
  association [1..1] to ZI_NK05_CustomerText as _CustomerText on znk05_atravel.customer_id = _CustomerText.CustomerId
{
